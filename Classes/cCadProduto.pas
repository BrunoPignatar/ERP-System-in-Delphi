...
uses Winapi.Windows, Winapi.Messages, System.SysUtils, System.Variants, System.Classes, Vcl.Graphics,
  ...
  published
    ...
    property qntmini: Double read  F_qntmini write F_qntmini;
  end;
...
begin
  try
    ...
    Qry.ParamByName('qntmini').AsFloat           :=Self.F_qntmini;
...
begin
  try
    ...
    QrySeleciona.SQL.Add(
      'SELECT produtoId, nome, descricao, valor, quantidade, categoriaId, foto, fornId, qntmini '+
      'FROM produtos '+
    ...
    try
      ...
      Self.F_foto.Assign(QrySeleciona.FieldByName('foto'));
      Self.F_qntmini := QrySeleciona.FieldByName('qntmini').AsFloat;
    except
    Result:=false;
    end;
...
begin
  try
    ...
    Qry.SQL.Add('UPDATE produtos '+
                ...
                '       ,foto          =:foto '+
                '       ,categoriaId   =:categoriaId, fornId =:fornId, qntmini =:qntmini '+
                ' WHERE produtoId=:produtoId ');
