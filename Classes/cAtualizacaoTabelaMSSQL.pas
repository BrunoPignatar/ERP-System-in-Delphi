...
type
  TAtualizaTableMSSQL = class(TAtualizaBancoDados)
    private
...
procedure TAtualizaTableMSSQL.Categoria;
begin
...
procedure TAtualizaTableMSSQL.Cliente;
begin
...
procedure TAtualizaTableMSSQL.VendasItens;
begin
