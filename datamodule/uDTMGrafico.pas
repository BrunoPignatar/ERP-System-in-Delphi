...
type
  TDTMGrafico = class(TDataModule)
    ...
    QryVendasUltimaSemanaLabel: TSQLTimeStampField;
    QryVendasUltimaSemanaValue: TFMTBCDField;
    dsGraficos: TDataSource;
    QryGraficos: TFDQuery;
    QryGraficosAnoMes: TWideStringField;
    QryGraficosTotalVendas: TFMTBCDField;
    dsProdutos: TDataSource;
    QryProdutos: TFDQuery;
    QryProdutosDataMes: TDateField;
    QryProdutosTotalMes: TFMTBCDField;
  private
