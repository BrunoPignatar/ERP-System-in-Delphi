...
begin
  ...
  begin
    DBGrid1.Canvas.Brush.Color := $00D8A76F;
  ...
  begin
    ...
    TDBGrid(Sender).Canvas.Brush.Color:=$00CCCCFF;
  end;
...
begin
  ...
  begin
    DBGrid2.Canvas.Brush.Color := $00D8A76F;
