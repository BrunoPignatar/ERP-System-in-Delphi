inherited frmCadProduto: TfrmCadProduto
  ...
  inherited pgcPrincipal: TPageControl
    ...
    inherited Manutenção: TTabSheet
      ...
      object Label3: TLabel
        ...
        Width = 148
        Height = 13
        Caption = 'Quantidade Minima no Estoque'
      end
      ...
      object edtprodutoId: TLabeledEdit
        ...
        EditLabel.Width = 33
        EditLabel.Height = 26
        EditLabel.Caption = 'Codigo'#13#10
        MaxLength = 10
        NumbersOnly = True
        TabOrder = 0
      end
  ...
  inherited QryListagem: TFDQuery
    SQL.Strings = (
      ...
      'LEFT JOIN fornecedor f '#10'ON f.fornid = p.fornid;')
    Left = 580
    Top = 32
    ...
    object QryListagemfornId: TIntegerField
      FieldName = 'fornId'
      Origin = 'fornId'
    end
    object QryListagemnomeFornecedor: TStringField
      FieldName = 'nomeFornecedor'
    ...
    object QryListagemqntmini: TFMTBCDField
      FieldName = 'qntmini'
      Origin = 'qntmini'
      Precision = 18
      Size = 5
  ...
  object QryFornecedor: TFDQuery
    ...
    Left = 224
    Top = 16
    object QryFornecedorfornId: TFDAutoIncField
      FieldName = 'fornId'
      ReadOnly = True
    end
