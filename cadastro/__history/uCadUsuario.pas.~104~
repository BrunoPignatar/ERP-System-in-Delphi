...
begin
  ...
  try
    ...
    try
      if lkpFuncao.Text = 'ESTOQUISTA' then begin
      Qry.SQL.Text :=
        'DELETE FROM usuariosAcaoAcesso WHERE usuarioId = :usuarioId; ' +
      ...
      end else if lkpFuncao.Text = 'ADM' then begin
        Qry.SQL.Text :=
        'DELETE FROM usuariosAcaoAcesso WHERE usuarioId = :usuarioId; ' +
        'INSERT INTO usuariosAcaoAcesso (usuarioId, acaoAcessoId, ativo) '+
        'SELECT :usuarioId, acaoAcessoId, ativo '+
      ...
      Qry.ParamByName('usuarioId').AsInteger := AUsuarioId;
      end else if lkpFuncao.Text = 'VENDEDOR'  then begin
        Qry.SQL.Text :=
        'DELETE FROM usuariosAcaoAcesso WHERE usuarioId = :usuarioId; ' +
        'INSERT INTO usuariosAcaoAcesso (usuarioId, acaoAcessoId, ativo) '+
        'SELECT :usuarioId, acaoAcessoId, ativo '+
