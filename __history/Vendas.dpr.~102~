...
uses
  ...
  uConProdutos in 'Consulta\uConProdutos.pas' {frmConProduto},
  cValidacaoDocumento in 'Classes\cValidacaoDocumento.pas',
...
begin
  ...
  Application.CreateForm(TfrmConFinanca, frmConFinanca);
  Application.Run;
end.
