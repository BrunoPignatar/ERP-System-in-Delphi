  ...
  uses
    ...
    Vcl.ComCtrls, Vcl.ExtCtrls, uDTMConexao, FireDAC.Stan.Intf, FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error,
    FireDAC.DatS, FireDAC.Phys.Intf, FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt, FireDAC.Comp.DataSet,
    FireDAC.Comp.Client, uEnum, RxToolEdit, RxCurrEdit, System.IniFiles;
  ...
  type
    ...
    private
      ...
      btnGravar, btnApagar:TBitBtn; Navegador:TDBNavigator; pgcPrincipal:TPageControl;
      Flag:Boolean);
  ...
  begin
    alabel.Caption:=RetornarCampoTraduzido(Campo);
     ...
     //pega o campo que foi clicado no grid
...
begin
  ...
  try
    for I := 0 to dbgrdListagem.Columns.Count - 1 do  // O laço percorre do 0 à ultima coluna desenhada no Grid
    begin
  ...
  QryListagem.Connection:=dtmConexao.dtmPrincipal;
...
begin
  ...
  try
    ...
    begin
      dbgrdListagem.Columns[I].Width := ArquivoINI.ReadInteger //Redefinimos a largura do grid baseado no que está desenhado
      (oUsuarioLogado.nome, // Pegamos o UsuarioLogado
      'Coluna_' + IntToStr(I),//Procuramos a anotação correspondente à coluna atual.
      dbgrdListagem.Columns[I].Width); //Se for primeiro acesso, mantém o Width padrão do Delphi.
    end;
  finally
   ...
   begin
    ...
    for I := 0 to ComponentCount -1 do begin
      if (Components[i] is TLabeledEdit) then begin
        ...
        then begin
         MessageDlg(TLabeledEdit(Components[i]).EditLabel.Caption + ' é um campo obrigatório',
